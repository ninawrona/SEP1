...
public class ReadWrite
{
  ...
  public static void manualWriteSessionList(SessionList sessions,
      String chosenClassGroup)//put Semester+ClassName.
  {
   ...
   */
  public static void manualWriteSessionListTeacher(SessionList sessions,
      String viaId)//put Semester+Teacher's VIA ID.
  {
