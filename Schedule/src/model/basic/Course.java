...
public class Course {
     ...
     * @param classGroup     the class this course is taught to.
     * @param teachers       the teacher(s) teaching this course.
     * @param semesterTaught the semester in which this course is taught.
     * @param ECTS           the ECTS value of this course.
     */
     ...
     *
     * @param teacher the Teacher object to be added to the course.
     */
     ...
     *
     * @param teacher the teacher to be removed from the course.
     */
     ...
     *
     * @param classGroup the classGroup to be assigned for the course.
     */
     ...
     *
     * @return a String representation of the Course object containing the name of the course.
     */
