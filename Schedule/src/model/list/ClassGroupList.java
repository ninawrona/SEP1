...
public class ClassGroupList {
     ...
     *
     * @param file file that contains information about each Student
     ...
     * assign them to the correct, already existing ClassGroup.
     *
     * @param file file that contains information about each Course
                        ...
                        if (courses.size() == 0) {
                            ...
                            for (int j = 0; j < teacherList.size(); j++) {
                                if (!(teacherList.get(j) == null)) {
                                    System.out.println("Teachers are not null");
                                }
                            }
