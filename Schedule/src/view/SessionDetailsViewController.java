...
public class SessionDetailsViewController {
    ...
    @FXML
    private TextArea courseDetailsField;
    @FXML
    private TextArea classDetailsField;
    @FXML
    private TextArea startTimeField;
    @FXML
    private TextArea endTimeField;
    @FXML
    private TextArea roomDetailsField;
    private Region root;
