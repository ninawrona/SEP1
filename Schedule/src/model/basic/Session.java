...
public class Session implements Comparable<Session>
{
  ...
  /**
   * A method for creating a copy of a Session.
   *
  ...
  /**
   * A method returning the string representation of some of the session's details.
   *
   * @return a String containing course name, date, and room or "unassigned" if the room is null.
   */
  ...
  /**
   * A Method for comparing sessions based on their start times.
   *
   * @param obj the Session object to be compared with.
   * @return -1, 0, or 1 depending on the values of the start times in seconds.
   */
